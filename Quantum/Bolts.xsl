<xsl:stylesheet xmlns:ddw1="urn:schemas-microsoft-com:office:spreadsheet" xmlns:ddw2="urn:schemas-microsoft-com:office:office" xmlns:ddw3="urn:schemas-microsoft-com:office:excel" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns:x="urn:schemas-microsoft-com:office:excel" version="1.0" exclude-result-prefixes="xsl ddwrt msxsl" xmlns:ddwrt="http://schemas.microsoft.com/WebParts/v2/DataView/runtime" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:ddwrt2="urn:frontpage:internal">
	...
	<xsl:template match="/" xmlns:ddw1="urn:schemas-microsoft-com:office:spreadsheet" xmlns:ddw2="urn:schemas-microsoft-com:office:office" xmlns:ddw3="urn:schemas-microsoft-com:office:excel" xmlns:ss="urn:schemas-microsoft-com:office:spreadsheet" xmlns:x="urn:schemas-microsoft-com:office:excel">
	...
	<xsl:template name="dvt_1">
		...
		<xsl:choose>
			...
			<xsl:otherwise>
				<table cellpadding="2" style="border: 1px solid #000000; width: 95%;" align="center">
					<tr valign="top">
						<th class="ms-vh" nowrap="nowrap" style="border: 1px solid #000000; width: 62px; height: 25px; white-space: nowrap;">Nr.</th>
						<th class="ms-vh" style="border: 1px solid #000000; width: 220px; height: 25px; white-space: nowrap;">Type</th>
						<th class="ms-vh" nowrap="nowrap" style="border: 1px solid #000000; height: 25px; white-space: nowrap;">Description</th>
						</tr>
			...
			<xsl:if test="true()">
				<xsl:if test="not($HideGroupDetail)" ddwrt:cf_ignore="1">
					<tr style="display:{$GroupStyle}">
						<td class="ms-vb" style="border: 1px solid #000000; width: 62px; white-space: nowrap;">
							<xsl:value-of select="ddw1:Cell[1]/ddw1:Data/text()"/>
						</td>
						<td class="ms-vb" style="border: 1px solid #000000; width: 220px; white-space: nowrap;">
							<xsl:value-of select="ddw1:Cell[2]/ddw1:Data/text()"/>
						</td>
						<td class="ms-vb" style="border: 1px solid #000000">
							<xsl:value-of select="ddw1:Cell[3]/ddw1:Data"/>
						</td>
						</tr>
				</xsl:if>
			</xsl:if>
